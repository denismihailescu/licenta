...
<section class="anunt">
    <div class="anunt-image">
        <img src="../img/6.jpg" alt="ajdhajdas">
    </div>
    <div class="anunt-details">
        <h1>ajdhajdas</h1>
        <p><strong>Model:</strong> Seria 3</p>
        <p><strong>Pret:</strong> 11000 EUR</p>
        <p><strong>Perioada leasing-ului:</strong> 12 luni</p>
        <p><strong>Contact:</strong> Email: dizzyhard02@gmail.com<br> Telefon: 0772255412</p>
    </div>
